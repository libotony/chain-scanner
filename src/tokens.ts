...
export enum AssetType { VET = 0, VTHO, 'PLA', 'SHA', 'EHrT', 'DBET', 'TIC', 'OCE', 'SNK', 'JUR', 'AQD', 'YEET', 'HAI', 'MDN', 'VEED', 'VPU', 'MVG', 'WoV', 'GEMS', 'VEX', 'VEUSD', 'VVET', 'DHN', 'UNION', 'VST', 'PPR', 'DRAGON', 'VSEA', 'BANANA', 'GOLD', 'LGCT', 'VFA', 'FCWS', 'MVC', 'MVA', '3DT', 'LION', 'SHT', 'SQUAD', 'BVC', 'USDV', 'VSC', 'Rain', 'MILK', 'EXO', 'PLG', 'TVIRC' = 100}
...
export const list:{ [index: string]: { [index: string]: Token } } = {
    "0x00000000851caf3cfdb6e899cf5958bfb1ac3413d346d43539627e6be7ec1b4a": {
        ...
        "EXO": {
            "name": "EXO Token",
            "symbol": "EXO",
            "address": "0xed864ba978a89ad8828c9d5ac44981e68486eda7",
            "decimals": 18
        },
        "PLG": {
            "name": "PLUG",
